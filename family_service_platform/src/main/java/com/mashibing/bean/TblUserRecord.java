...
public class TblUserRecord implements Serializable {
    ...
    public TblUserRecord(Integer id, String userName, String userPassword, String userType, TblRole tblRole, String userGender, TblDept tblDept, Integer userJob, String userStatus, String officePhone, String innerPhone, String movePhone, String email, String isSendMsg, LocalDateTime startDate, LocalDateTime stopDate, LocalDateTime birthday, String ipRule, LocalDateTime userHiredate, String isSendWchat, String remark, TblCompany tblCompany, String isDeptAdmin, LocalDateTime lastLoginDate, String createPerson, LocalDateTime createDate) {
        this.id = id;
